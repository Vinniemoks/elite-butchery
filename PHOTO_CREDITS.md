...
> Cuts currently shown with a line-art icon (no photo yet): **Soup Bones, T-Bone, Beef Fillet, Chicken Thighs, Chicken Wings.** Add `assets/img/<id>.jpg` (e.g. `t-bone.jpg`, `chicken-wings.jpg`) to give them a photo.
>
> Note: the **T-Bone** photo supplied carried a stock watermark, so it was not used — send a clean/AI version.
>

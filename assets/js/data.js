...
window.BUTCHERY_DEFAULTS = {
  ...
  products: [
    ...
    { id: "beef-mince",     name: "Minced Meat",       swahili: "Kima",             category: "Beef",    art: "mince", img: "assets/img/beef-mince.jpg",    unit: "kg", price: 870,  step: 0.5, min: 0.5, available: true, tag: "",
      desc: "Freshly ground lean beef for keema, burgers, samosas, bolognese and more." },
    { id: "soup-bones",     name: "Soup Bones",        swahili: "Mifupa",           category: "Beef",    art: "beef",  img: "",                             unit: "kg", price: 300,  step: 0.5, min: 0.5, available: true, tag: "",
    ...
    { id: "ribeye",         name: "Ribeye Steak",      swahili: "",                 category: "Beef",    art: "steak", img: "assets/img/beef-boneless.jpg", unit: "kg", price: 980,  step: 0.5, min: 0.5, available: true, tag: "Steakhouse",
    ...
    /* ---------------- GOAT ---------------- */
    { id: "goat",           name: "Goat Meat",         swahili: "Mbuzi",            category: "Goat",    art: "goat",  img: "assets/img/goat.jpg",          unit: "kg", price: 900,  step: 0.5, min: 0.5, available: true, tag: "Choma favourite",
    ...
    { id: "chicken-boneless", name: "Boneless Chicken", swahili: "",                category: "Chicken", art: "chicken", img: "",                            unit: "kg", price: 880,  step: 0.5, min: 0.5, available: true, tag: "",
      desc: "Skinless, boneless chicken fillets — quick to cook and perfect for any recipe." },
    { id: "chicken-thighs", name: "Chicken Thighs",    swahili: "",                 category: "Chicken", art: "chicken", img: "",                            unit: "kg", price: 780,  step: 0.5, min: 0.5, available: true, tag: "",
      desc: "Juicy bone-in thighs — full of flavour for frying, roasting and stews." },
    { id: "drumsticks",     name: "Chicken Drumsticks", swahili: "",                category: "Chicken", art: "chicken", img: "",                            unit: "kg", price: 780,  step: 0.5, min: 0.5, available: true, tag: "",
